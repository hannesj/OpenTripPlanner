...
import org.opentripplanner.ext.isochrone.geometry.AccumulativeGridSampler;
import org.opentripplanner.ext.isochrone.geometry.AccumulativeMetric;
import org.opentripplanner.ext.isochrone.geometry.SparseMatrixZSampleGrid;
import org.opentripplanner.ext.isochrone.geometry.ZSampleGrid;
import org.opentripplanner.ext.isochrone.spt.SPTVisitor;
import org.opentripplanner.ext.isochrone.spt.SPTWalker;
...
public class SampleGridRenderer {
  ...
  public static ZSampleGrid<WTWD> getSampleGrid(
    ...
    final double gridSizeMeters = isochroneRequest.precisionMeters;
    ...
    sampleSPT(
      ...
      offRoadWalkSpeedMps,
      (int) isochroneRequest.maxCutoff.getSeconds(),
      cosLat
    );
