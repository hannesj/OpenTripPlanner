...
public abstract class SpiderwebSimpleFeature implements SimpleFeature {
    ...
    try {
      featureType =
        DataUtilities.createType(
          "feature",
          "geom:Geometry,mode:String,color:String,time:String,name:String,parent:Integer,trip:String,route:String,departureTime:String,staySeated:Boolean"
        );
